...
public class AdvancedUtil {
    ...
    public static String makeVideoCustomMessage(String openId, String mediaId, String thumbMediaId) {
        String jsonMsg =
            "{\"touser\":\"%s\",\"msgtype\":\"video\",\"video\":{\"media_id\":\"%s\",\"thumb_media_id\":\"%s\"}}";
     ...
     * @return WeixinAouth2Token
     appid=wxbf245420dadddff5
     SECRET=8f9a52d13da3bc7a3d37567eef0791c9
     code=041bac83096c5c8a8e1e072b8e6ff4fJ
     */
    public static void main(String[] args) {
        WeixinOauth2Token wt =
            getOauth2AccessToken("wxbf245420dadddff5", "8f9a52d13da3bc7a3d37567eef0791c9",
                                 "041bac83096c5c8a8e1e072b8e6ff4fJ");
        System.out.println(wt.getAccessToken() + " opId=" + wt.getOpenId());
    }
    ...
    public static JsApiTicket getJSAPITicket(String token) {
        ...
        String requestUrl = "https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token=ATOKEN&type=jsapi";
        requestUrl = requestUrl.replace("ATOKEN", token);
        JSONObject jsonObject = CommonUtil.httpsRequest(requestUrl, "GET", null);
        if (null == jsonObject) {
        ...
        JsApiTicket res = new JsApiTicket(jsonObject.getString("ticket"), jsonObject.getInt("expires_in"), new Date());
        return res;
    }
    ...
    public static WeixinQRCode createTemporaryQRCode(String accessToken, int expireSeconds, int sceneId) {
        ...
        // 需要提交的json数据
        String jsonMsg =
            "{\"expire_seconds\": %d, \"action_name\": \"QR_SCENE\", \"action_info\": {\"scene\": {\"scene_id111\": %d}}}";

        // 创建临时带参二维码
        JSONObject jsonObject =
            CommonUtil.httpsRequest(requestUrl, "POST", String.format(jsonMsg, expireSeconds, sceneId));
     ...
     * @return ticket
     */
    public static JSONObject createPermanentQRCode(String accessToken, int sceneId) {
        String ticket = null;
        // 拼接请求地址
        String requestUrl = "https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=ACCESS_TOKEN";
        requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken);
    ...
    public static byte[] getQRCodeImage(String ticket) {
        ...
        try {
            ...
            while ((size = bis.read(buf)) != -1) {
                swapStream.write(buf, 0, size);
            }


            bis.close();
            conn.disconnect();
            log.info("根据ticket换取二维码图片成功，filePath=" + filePath);
    ...
    public static WeixinUserInfo getUserInfo(String accessToken, String openId) {
        System.out.println(accessToken + " oid=" + openId);
        ...
        if (null != jsonObject) {
            try {
                ...
                if (0 == weixinUserInfo.getSubscribe()) {
                    weixinUserInfo.setSubscribeTime("0");
    ...
    public static boolean updateGroup(String accessToken, int groupId, String groupName) {
        ...
        // 修改分组名
        JSONObject jsonObject =
            CommonUtil.httpsRequest(requestUrl, "POST", String.format(jsonData, groupId, groupName));
    ...
    /** by jgk*/
    public static WeixinMedia uploadBufferedImageMedia(String accessToken, String type, BufferedImage image) {
        WeixinMedia weixinMedia = null;
        // 拼装请求地址
        String uploadMediaUrl =
            "http://file.api.weixin.qq.com/cgi-bin/media/upload?access_token=ACCESS_TOKEN&type=TYPE";
        ...
        try {
            ...
            // 从请求头中获取内容类型
            String contentType = "image/jpeg;charset=GB2312";
            // 根据内容类型判断文件扩展名
            String fileExt = ".jpg";
            // 请求体开始
            outputStream.write(("--" + boundary + "\r\n").getBytes());
    ...
    public static void main1(String args[]) {
        ...
        // 组装文本客服消息
        String jsonTextMsg =
            makeTextCustomMessage("oEdzejiHCDqafJbz4WNJtWTMbDcE",
