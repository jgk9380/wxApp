...
public class SmsClientKeyword {
	 ...
	 * <p>
	 * <date>2012-03-01</date><br/>
	 * <span>是否包含关键字获取方�?1--必须传入必填内容</span><br/>
	 * <p>
	 * 其一：发送方式，默认为POST<br/>
	 ...
	 * 
	 * @param url
	 *            ：必�?--发�?�连接地�?URL--比如>http://118.145.30.35/sms.aspx
	 * @param userid
	 *            ：必�?--用户ID，为数字
	 * @param account
	 *            ：必�?--用户帐号
	 ...
	 *            ：必�?--用户密码
	 * @param checkWord
	 *            ：必�?--�?要检查的字符�?--比如：这个字符串中是否包含了屏蔽�?
	 * @return 返回�?要查询的字符串中是否包含关键�?
	 */
