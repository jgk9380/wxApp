...
public class JSFUtils {
    ...
    /**
     * Convenience method for resolving a reference to a managed bean by title
     * rather than by expression.
     * @param beanName title of managed bean
     * @return Managed object
     */
    ...
    /**
     * Convenience method for setting the value of a managed bean by title
     * rather than by expression.
     * @param beanName title of managed bean
     * @param newValue new value to set
     */
    ...
    public static void addFacesJSFInformationMessage(String commpontID, String summary, String detail) {
        FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_ERROR, summary, detail);
        FacesContext ctx = getFacesContext();
        ctx.addMessage(commpontID, msg);
    }
     ...
     * @param attrName title of attribute
     * @param msg error message string
     */
    public static void addFacesErrorPosMessage(String pos, String msg) {
