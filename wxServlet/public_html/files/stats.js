;(function (global) {
    ...
    Ta.hack = function () {
        return {
            params : '', conf :  {
                sid : 34915524, pf : 1, logo : 255, hot :  {
                }
            }
        };
    };
    ...
    function q(c, a, b) {
        ...
        var d = {
            "com.cn" : 1, "net.cn" : 1, "gov.cn" : 1, "com.hk" : 1, "co.nz" : 1, "org.cn" : 1, "edu.cn" : 1
        },
        e = a.split(".");2 < e.length && (a = (d[e.slice( - 2).join(".")] ? e.slice( - 3) : e.slice( - 2)).join("."));
    ...
    function l(c) {
        ...
        return {
            host : c, path : a, search : b, hash : d, param : e
        }
    }
    ...
    function s(c, a) {
        ...
        b.onload = b.onerror = b.onreadystatechange = function () {
            /loaded|complete|undefined/.test(b.readyState) && (b.onload = b.onerror = b.onreadystatechange = null, b.parentNode.removeChild(b), b = 
            void 0, a())
        };
    ...
    function w() {
        var c = l(), a = {
            dm : c.host, pvi : "", si : "", url : c.path, arg : encodeURIComponent(c.search || ""), ty : 1
        };
        a.pvi = function () {
            var b = p("pgv_pvi");
...
();
    ...
    function x() {
        ...
        return {
            rdm : c.host, rurl : c.path, rarg : encodeURIComponent(c.search || ""), adt : a.param.ADTAG || a.param.adtag
        }
    }
    ...
    function y() {
        try {
            ...
            var b = {
                fl : "", scr : d, scl : e, lg : h, jv : f, tz : g, ct : a
            },
            m, k, l, n;
    ...
    function A() {
        var c = [], a;
        for (a in k) {
            var b = p(k[a].c_id), d;"afs" == a ? d = (d = /ssid=([^&]*)/i.exec(l().hash)) && d[1] ? d[1] : "" : (d = l().param, d = d[k[a].id] ? d[k[a].id] : "");
...
();
        if (g.sid && !Ta[g.sid]) {
            for (var a = [], b = 0, d = [w(), x(), {r2 : g.sid, r3 : "undefined" == typeof _speedMark ? "-1" : new Date - _speedMark, r4 : g.pf || 1},y(), z(), A(), {random :  + new Date}], e = d.length;b < e;b++)
                for (var h in d[b])
            ...
            f.src = a;(1 * !g.pf || g.hot.isValid) && B(a);
    ...
    function B(c) {
        ...
        };1 * g.pf ? (new RegExp(b)).test(g.hot.url) && e() : (a = g.sid, s("http://tcss.qq.com/heatmap/" + a % 100 + "/" + v(a) + ".js?random=" +  + new Date, function () {
            var a;
    ...
    function C(c) {
        var a = {
            9 : "\u817e\u8baf\u5206\u6790", 10 : "\u7f51\u7ad9\u7edf\u8ba1", df : '<img src="' + (("https:" == document.location.protocol ? "https:" : "http:") + "//tajs.qq.com/icon/toss_" + c + ".gif") + '" border="0" />'
        };
        document.write(['<a href="http://ta.qq.com?ADTAG=FROUM.FOOTER.CLICK.ICON" title="\u817e\u8baf\u5206\u6790" target="_blank">', a[c] || a.df, "</a>"].join(""))
    }
    var k = {
        afs :  {
            key : 1, id : "ssid", c_id : "pgv_afsid", fr : "hash"
        },
        afc :  {
            key : 2, id : "__tacid", c_id : "pgv_afcid", fr : "param"
        },
        gdt :  {
            key : 11, id : "qz_gdt", c_id : "pgv_gdtid", fr : "param"
        }
    };
    n.pgvSendClick = u;
    n.taClick = u;
    ...
    Ta.pgv = t;!Ta.async && t(Ta.hack ? Ta.hack() : "")
})( {
    sid : "", pf : "", hot :  {
        url : "", isValid : !1
    }
